...
public class InitialContextImpl implements InitialContext {
    ...
    public Object lookup(String clazzName) {

        Object object = null;

        if (Object.class.getCanonicalName().equalsIgnoreCase(clazzName)) {
            object = new Object();
        } else if (Double.class.getCanonicalName().equalsIgnoreCase(clazzName)) {
